...
#API_URL = "https://site.api.espn.com/apis/site/v2/sports/hockey/nhl/scoreboard?dates=20240420-20240624"
...
def extract_round_name(notes_headline):
    ...
    for part in parts:
        if "Wild Card" in part or "ALWC" in part or "NLWC" in part:
            ...
            return "First Round"
        elif "Second Round" in part or "2nd Round" in part:
            return "Second Round"
    ...
    for event in data.get('events', []):
        for competition in event.get('competitions', []):
            ...
            if series_title not in series_dict:
                series_dict[series_title] = {
                    ...
                    "seriesDetails": {
                        ...
                        "seriesGames": [],
                        "maxGames": 7  # Default value (NHL playoffs are best-of-7)
                    }
                }
            ...
            if status_info.get('type', {}).get('completed', False):
                ...
                if period_num <= 3:
                    game_segment = f"P{period_num}"  # NHL: P1, P2, P3
                else:
